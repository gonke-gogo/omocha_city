...
ActiveRecord::Schema[7.0].define(version: 20_230_308_040_847) do
  ...
  create_table 'follow_relationships', force: :cascade do |t|
    ...
    t.index %w[following_id follower_id], name: 'index_follow_relationships_on_following_id_and_follower_id',
                                          unique: true
  ...
  create_table 'posts', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.string 'rakuten_toyname'
    t.string 'rakuten_toyimage'
